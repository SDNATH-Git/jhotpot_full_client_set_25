...
const BenefitCard = ({ title, description, image, index }) => {
  ...
  return (
    <motion.div
      ...
      className={`group flex flex-col items-center text-center p-6 rounded-3xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-b-2 border-[#0D5EA6]  hover:border-[#0D5EA6]/50 ${gradientBg}`}
    >
      <motion.img
